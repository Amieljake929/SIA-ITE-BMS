...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <header class="bg-white shadow-lg border-b border-green-100 px-6 py-4 relative">
    <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            <h1 class="text-xl font-bold text-green-800">Admin | Resident Information System</h1>
  ...
  <main class="container mx-auto px-4 py-8 flex-grow">
    ...
    <div class="grid grid-cols-2 gap-5 sm:gap-6 max-w-4xl mx-auto mb-12">
      <!-- Card 1 -->
      <a href="ris_resident_registration.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
          <i class="fas fa-gavel"></i>
        </div>
        <h3 class="text-base sm:text-lg font-semibold text-gray-800">Resident Registration</h3>
      </a>
      ...
      <!-- Card 3 -->
      <a href="Programs/A_programs.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
      ...
      <!-- Card 4 -->
      <a href="Accounts/A_account_management.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
          <i class="fas fa-file-signature"></i>
        </div>
        <h3 class="text-base sm:text-lg font-semibold text-gray-800">Account Management</h3>
      </a>

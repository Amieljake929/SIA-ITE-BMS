...
// Get notification counts for Official (same as staff - pending items)
$request_count = 0;
$sql = "SELECT COUNT(*) as count FROM barangay_clearance WHERE status = 'Validated'";
...
$blotter_count = 0;
$sql = "SELECT COUNT(*) as count FROM blotter_and_reports WHERE status = 'For Approval'";
$result = $conn->query($sql);
if ($result) {
    $row = $result->fetch_assoc();
...
$community_count = 0;
$sql = "SELECT COUNT(*) as count FROM community_reports WHERE status IN ('For Closing')";
$result = $conn->query($sql);
if ($result) {
    $row = $result->fetch_assoc();
...
<head>
  ...
  <title>BagbagCare - Official Portal</title>
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <header class="bg-white shadow-lg border-b border-green-100 px-6 py-4 relative">
    <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            <h1 class="text-xl font-bold text-green-800">BagbagCare | Officials</h1>
  ...
  <main class="container mx-auto px-4 py-8 flex-grow">
    ...
    <div class="grid grid-cols-2 gap-5 sm:gap-6 max-w-4xl mx-auto mb-12">
      ...
      <!-- Card 4 -->
      <a href="Request_Documents_official/O.official_request_documents.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
      ...
      <!-- Card 5 -->
      <a href="Blotter_Reports/O.blotter_reports.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
      ...
      <!-- Card 6 -->
      <a href="Community_Reports/O.community_reports.php" class="card-container group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
        <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">

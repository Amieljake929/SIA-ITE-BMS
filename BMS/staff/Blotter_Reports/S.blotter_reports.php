...
<main class="px-6 py-8">
  <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow">
    <h2 class="text-xl font-bold text-green-800 mb-4">Pending Blotter Reports</h2>
    ...
    <table class="min-w-full border border-gray-300">
      ...
      <tbody>
        ...
        <tr class="border-t">
          <td class="px-4 py-2"><?= htmlspecialchars($r['complainant_first_name'] . ' ' . $r['complainant_last_name']) ?></td>
          <td class="px-4 py-2"><?= htmlspecialchars($r['incident_type']) ?></td>
          <td class="px-4 py-2"><?= $r['incident_date'] ?></td>
          <td class="px-4 py-2">
          ...
          <td class="px-4 py-2">
            <a href="S.view_report.php?id=<?= $r['id'] ?>" class="text-blue-600 hover:underline">View</a>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>

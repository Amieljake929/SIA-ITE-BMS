...
<head>
  ...
  <title>Document Requests - Staff Portal</title>
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <!-- Document Type Tabs (Horizontal Button Group) -->
                ...
                <tr class="hover:bg-gray-50 transition">
                  ...
                  <td class="px-6 py-3 text-sm">
                    <div class="flex space-x-2">
                      <!-- View Details -->
                      <a href="R.view_document_details.php?tab=<?= $active_tab ?>&id=<?= $row['id'] ?>"
                 ...
                 <!-- Validate Button -->
                        <a href="R.validate_document.php?tab=<?= $active_tab ?>&id=<?= $row['id'] ?>"
                          class="bg-yellow-500 text-white px-3 py-1 rounded text-xs hover:bg-yellow-600 transition flex items-center">
                            <i class="fas fa-check-circle mr-1"></i> Validate
                             </a>
                            <!-- Reject Button -->
                            <a href="R.reject_document.php?tab=<?= $active_tab ?>&id=<?= $row['id'] ?>"
                      ...
                      <?php if ($row['status'] === 'Approved'): ?>
                        <a href="print_document.php?tab=<?= $active_tab ?>&id=<?= $row['id'] ?>"
                           target="_blank"

...
$stmt = $conn->prepare("SELECT id, status, cedula_id FROM cedula WHERE user_id = ? AND status IN ('Pending', 'Validated', 'Approved') ORDER BY application_date DESC LIMIT 1");
...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      // Form validation and signature checking

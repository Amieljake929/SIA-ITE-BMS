...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <main class="flex-grow px-6 py-8">
    <div class="container mx-auto">
      <h2 class="text-2xl font-bold text-green-900 mb-6 text-center">Available Services</h2>

      <!-- Grid: 2 cards per row on mobile, 3 on larger screens -->
      <div class="grid grid-cols-2 gap-5 sm:gap-6 md:grid-cols-3 max-w-5xl mx-auto">
        ...
        ?>
          <a href="<?= $service['link'] ?>"
             class="group bg-white border border-gray-200 p-5 rounded-xl shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center h-44">
            <div class="text-green-600 mb-3 text-4xl group-hover:scale-110 transition-transform duration-300">
              <i class="<?= $service['icon'] ?>"></i>
            </div>
            <h3 class="text-sm sm:text-base font-semibold text-gray-800 leading-tight">

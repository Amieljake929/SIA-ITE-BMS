...
$stmt_check = $conn->prepare("SELECT id, status, residency_id FROM certificate_of_residency WHERE user_id = ? AND status IN ('Pending', 'Validated', 'Approved') ORDER BY application_date DESC LIMIT 1");

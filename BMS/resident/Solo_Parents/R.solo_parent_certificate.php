...
<body class="bg-gray-50 text-gray-800 font-sans flex flex-col min-h-screen">
  ...
  <main class="flex-grow px-6 py-8">
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-100">
      ...
      <h2 class="text-2xl font-bold text-green-800 mb-6 text-center">Solo Parent Certificate</h2>
        ...
        <div class="bg-green-50 border-l-4 border-green-400 p-6 mb-8 rounded-lg">
          <div class="flex items-start">
            ...
            <div class="ml-4">
              ...
              <p class="text-green-700 mt-1">Your Solo Parent Certificate has been <strong>approved</strong>.</p>
              <p class="text-sm text-green-600 mt-2">
                <strong>📄 Certificate ID:</strong> <?= htmlspecialchars($active_request['solo_parent_id']) ?><br>
  ...
  <p id="emailError" class="text-red-500 text-xs mt-1 hidden">Please enter a valid email address.</p>
          ...
          <section class="mb-8">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Reason for Solo Parent Status</label>
              <select name="category" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-green-500 transition" required>
                ...
                <option value="Solo by Choice">Solo by Choice</option>
          ...
          <section class="mb-8">
            ...
            <div id="childrenContainer">
              <div class="child-row">
                <div>
                  ...
                  <input type="text" name="child_first_name[]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm" required>
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-600">Middle Name</label>
                  <input type="text" name="child_middle_name[]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-600">Last Name</label>
                  <input type="text" name="child_last_name[]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm" required>
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-600">Date of Birth</label>
                  <input type="date" name="child_dob[]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm" required>
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-600">Civil Status</label>
                  <select name="child_civil_status[]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm" required>
            ...
            <button type="button" id="addChild" class="mt-2 text-sm text-green-600 hover:text-green-800 font-medium">
